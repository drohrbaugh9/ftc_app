...
public final class ShooterPID {
    ...
    private static double realTicsTarget = TICS_PER_ROTATION * (realRPMtarget / 60.0) * (MEASURING_INTERVAL / 1000.0);
    ...
    public static void calcuateTicsTarget(double realRPM) {
