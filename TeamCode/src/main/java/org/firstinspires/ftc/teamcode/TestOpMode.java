...
@Autonomous(name = "Test5", group = "Test")
@Disabled
public class TestOpMode extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        servo2 = hardwareMap.servo.get("zervo");
    ...
    /*/ //new I2C_ColorSensor class test
    public void runOpMode() throws InterruptedException {
        I2C_ColorSensor color = new I2C_ColorSensor();
        color.get(this, "colorFront", 0x3c);
        ...
        while (opModeIsActive()) {
            Util.telemetry("red", color.normalizedRed(), false);
            Util.telemetry("green", color.normalizedGreen(), false);
            Util.telemetry("blue", color.normalizedBlue(), true);
            Thread.sleep(10);
        }
    }
    /**/
    ...
    public void runOpMode() throws InterruptedException {
        ...
        AutoUtil.encoderSteerForward(4000, 0.3, false);
