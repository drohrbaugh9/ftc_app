...
/* This class is the Tele-Op program we used for the Velocity
   Vortex season
*/
public class FinalTeleOp extends LinearOpMode {

    private DcMotor rightBack, leftBack, rightFront, leftFront; // drive motors
    private DcMotor intake, shooter1, shooter2; // other motors

    private Servo ballFeeder; // servo that pushes particles between shooter wheels

    private OpticalDistanceSensor ods, ods2; // optical distance sensors, used to detect lines
